...
export const MCP_PRESETS: McpPreset[] = [
	...
	},
	{
		...
		icon: "📄",
		description:
			"Fetch and read any public URL as plain text or markdown via Cloudflare Browser Rendering",
	...
	},
	{
		...
		authNote:
			"Requires DD-API-KEY: <KEY> and DD-APPLICATION-KEY: <KEY> headers (from Datadog → Organization Settings → API Keys)",
	...
	},
	{
		...
		icon: "🌍",
		description:
			"Google's open knowledge graph — global stats on health, economy, demographics, and more",
