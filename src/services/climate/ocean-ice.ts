...
export function toDisplayOceanIceData(proto: ProtoOceanIceData): OceanIceIndicators {
	...
	return {
		...
		...(hasFinite(proto, "arcticExtentAnomalyMkm2")
			? { arcticExtentAnomalyMkm2: proto.arcticExtentAnomalyMkm2 }
			: {}),
		...(typeof proto.arcticTrend === "string" && proto.arcticTrend
			? { arcticTrend: proto.arcticTrend }
			: {}),
		...(hasFinite(proto, "seaLevelMmAbove1993")
			? { seaLevelMmAbove1993: proto.seaLevelMmAbove1993 }
			: {}),
		...(hasFinite(proto, "seaLevelAnnualRiseMm")
			? { seaLevelAnnualRiseMm: proto.seaLevelAnnualRiseMm }
			: {}),
...
export function normalizeHydratedOceanIce(
	...
	const points = Array.isArray(raw.ice_trend_12m)
		? raw.ice_trend_12m
				.filter(
					(point): point is OceanIceSeedSnakePoint =>
						point != null &&
