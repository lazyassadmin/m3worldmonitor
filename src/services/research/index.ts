...
const arxivBreaker = createCircuitBreaker<ArxivPaper[]>({
	name: "ArXiv Papers",
	cacheTtlMs: 10 * 60 * 1000,
	persistCache: true,
});
const trendingBreaker = createCircuitBreaker<GithubRepo[]>({
	name: "GitHub Trending",
	cacheTtlMs: 10 * 60 * 1000,
	persistCache: true,
});
const hnBreaker = createCircuitBreaker<HackernewsItem[]>({
	name: "Hacker News",
	cacheTtlMs: 10 * 60 * 1000,
	persistCache: true,
});
