...
export const GLOBE_RENDER_SCALE_OPTIONS: {
	...
	{
		value: "auto",
		labelKey: "components.insights.globeRenderScaleOptions.auto",
		fallbackLabel: "Auto (device)",
	},
	{
		value: "1",
		labelKey: "components.insights.globeRenderScaleOptions.1",
		fallbackLabel: "Eco (1x)",
	},
	{
		value: "1.5",
		labelKey: "components.insights.globeRenderScaleOptions.1_5",
		fallbackLabel: "Sharp (1.5x)",
	},
	{
		value: "2",
		labelKey: "components.insights.globeRenderScaleOptions.2",
		fallbackLabel: "4K (2x)",
		disabled: true,
	},
	{
		value: "3",
		labelKey: "components.insights.globeRenderScaleOptions.3",
		fallbackLabel: "Insane (3x)",
		disabled: true,
	},
];
...
export function subscribeGlobeVisualPresetChange(
	cb: (preset: GlobeVisualPreset) => void,
): () => void {
	const handler = (e: Event) => {
