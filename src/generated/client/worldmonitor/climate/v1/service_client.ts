...
export class ClimateServiceClient {
	...
	async getCo2Monitoring(
		req: GetCo2MonitoringRequest,
		options?: ClimateServiceCallOptions,
	...
	async getOceanIceData(
		req: GetOceanIceDataRequest,
		options?: ClimateServiceCallOptions,
	...
	async listAirQualityData(
		req: ListAirQualityDataRequest,
		options?: ClimateServiceCallOptions,
	...
	async listClimateNews(
		req: ListClimateNewsRequest,
		options?: ClimateServiceCallOptions,
