...
export class MarketServiceClient {
	...
	async listCryptoSectors(
		req: ListCryptoSectorsRequest,
		options?: MarketServiceCallOptions,
	...
	async listDefiTokens(
		req: ListDefiTokensRequest,
		options?: MarketServiceCallOptions,
	...
	async listOtherTokens(
		req: ListOtherTokensRequest,
		options?: MarketServiceCallOptions,
