...
export class RadiationServiceClient {
	...
	async listRadiationObservations(
		req: ListRadiationObservationsRequest,
		options?: RadiationServiceCallOptions,
