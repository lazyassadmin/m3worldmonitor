...
export class ConsumerPricesServiceClient {
	...
	async getConsumerPriceOverview(
		...
		if (req.marketCode != null && req.marketCode !== "")
			params.set("market_code", String(req.marketCode));
		if (req.basketSlug != null && req.basketSlug !== "")
			params.set("basket_slug", String(req.basketSlug));
	...
	async getConsumerPriceBasketSeries(
	...
	async listConsumerPriceCategories(
	...
	async listConsumerPriceMovers(
		...
		if (req.categorySlug != null && req.categorySlug !== "")
			params.set("category_slug", String(req.categorySlug));
		const url = this.baseURL + path + (params.toString() ? "?" + params.toString() : "");
	...
	async listRetailerPriceSpreads(
	...
	async getConsumerPriceFreshness(
