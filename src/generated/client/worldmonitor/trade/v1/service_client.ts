...
export class TradeServiceClient {
	...
	async getCustomsRevenue(
		req: GetCustomsRevenueRequest,
		options?: TradeServiceCallOptions,
	...
	async listComtradeFlows(
		req: ListComtradeFlowsRequest,
		options?: TradeServiceCallOptions,
	): Promise<ListComtradeFlowsResponse> {
		let path = "/api/trade/v1/list-comtrade-flows";
		const params = new URLSearchParams();
		if (req.reporterCode != null && req.reporterCode !== "")
			params.set("reporter_code", String(req.reporterCode));
