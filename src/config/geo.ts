...
export const INTEL_HOTSPOTS: Hotspot[] = [
	{
		...
		history: {
			...
			precedentDescription:
				"4 military coups in 3 years (Mali 2020/2021, Burkina Faso 2022, Niger 2023)",
	...
	},
	{
		...
		history: {
			...
			precedentCount: 3,
			precedentDescription:
				"Repeated state collapse (2004 Aristide, 2021 Moïse assassination, 2024 gang takeover)",
	...
	},
	{
		...
		history: {
			...
			precedentCount: 5,
			precedentDescription:
				"Ethiopia-Eritrea war, Tigray war, Somali civil war, Sudan coups, piracy waves",
	...
	},
	{
		...
		history: {
			...
			precedentCount: 3,
			precedentDescription:
				"Recurring border crises, TTP resurgence post-2021, militant sanctuaries in Afghanistan",
	...
	},
	{
		...
		whyItMatters:
			"Largest economy by PPP; primary US strategic competitor; Taiwan contingency risk",
	},
	{
		id: "kyiv",
		name: "Kyiv",
		...
		whyItMatters:
			"Largest European war since WWII; NATO Article 5 test; global food/energy security",
	},
	{
		id: "taipei",
		name: "Taipei",
	...
	},
	{
		...
		history: {
			...
			precedentCount: 4,
			precedentDescription:
				"Revolution 1979, Iran-Iraq War, JCPOA negotiations, Soleimani assassination",
			cyclicalRisk: "Quds Day (annually), Khamenei health status",
		},
		whyItMatters:
			"Near-nuclear threshold state; controls Strait of Hormuz; Axis of Resistance coordinator",
	},
	{
		id: "telaviv",
		name: "Tel Aviv",
	...
	},
	{
		...
		history: {
			...
			precedentCount: 4,
			precedentDescription:
				"Korean War 1950-53, nuclear tests 2006-2017, Trump summits, missile tests ongoing",
...
export const STRATEGIC_WATERWAYS: StrategicWaterway[] = [
	{
		...
		lat: 24.0,
		lon: 119.5,
		description: "Critical shipping lane, PLA activity",
	},
	{
		id: "malacca_strait",
		name: "MALACCA STRAIT",
		lat: 2.5,
		lon: 101.5,
		description: "Major oil shipping route",
	},
	{
		id: "hormuz_strait",
		...
		lat: 26.5,
		lon: 56.5,
		description: "Oil chokepoint, Iran control",
	},
	{
		id: "bosphorus",
		...
		lat: 41.1,
		lon: 29.0,
		description: "Black Sea access, Turkey control",
	},
	{ id: "suez", name: "SUEZ CANAL", lat: 30.5, lon: 32.3, description: "Europe-Asia shipping" },
	{
		...
		lat: 9.1,
		lon: -79.7,
		description: "Americas shipping route",
	},
	{
		id: "gibraltar",
		...
		lat: 35.9,
		lon: -5.6,
		description: "Mediterranean access, NATO control",
	},
	{
		id: "bab_el_mandeb",
		name: "BAB EL-MANDEB",
		lat: 12.5,
		lon: 43.3,
		description: "Red Sea chokepoint, Houthi attacks",
	},
	{
		...
		lat: -34.36,
		lon: 18.49,
		description: "Suez bypass route, tanker traffic",
	},
	{
		id: "dover_strait",
		name: "DOVER STRAIT",
		lat: 51.0,
		lon: 1.5,
		description: "English Channel narrows, busiest shipping lane",
	},
	{
		id: "korea_strait",
		name: "KOREA STRAIT",
		lat: 34.0,
		lon: 129.0,
		description: "Japan-Korea shipping lane",
	},
	{
		id: "kerch_strait",
		name: "KERCH STRAIT",
		lat: 45.3,
		lon: 36.6,
		description: "Black Sea-Azov access, Russia-Ukraine flashpoint",
	},
	{
		id: "lombok_strait",
		name: "LOMBOK STRAIT",
		lat: -8.5,
		lon: 115.7,
		description: "Malacca bypass for deep-draft vessels",
	},
];
...
export const CONFLICT_ZONES: ConflictZone[] = [
	...
	},
	{
		...
		description:
			"Civil war following 2021 military coup. Resistance forces and ethnic armed organizations have captured significant territory. Junta losing control of border regions. Multiple coordinated offensives ongoing.",
		keyDevelopments: [
	...
	},
	{
		...
		description:
			"250km-long, 4km-wide buffer zone along the Military Demarcation Line established by the 1953 Korean Armistice Agreement. Despite its name, one of the most heavily militarized borders in the world.",
		center: [127.27, 38.14],
		coords: [
			[126.0955, 37.7876],
			[126.2448, 37.8175],
...
const US_DOMESTIC_BASES: MilitaryBase[] = [
	{
		...
		lon: -76.31,
		type: "us-nato",
		description: "World largest naval base. Atlantic Fleet HQ.",
	},
	{
		id: "fort_liberty",
		name: "Fort Liberty",
		...
		lon: -79.0,
		type: "us-nato",
		description: "Army Special Ops. XVIII Airborne Corps.",
	},
	{
		id: "pendleton",
		name: "Camp Pendleton",
		...
		lon: -117.4,
		type: "us-nato",
		description: "USMC West Coast. 1st Marine Division.",
	},
	{
		id: "san_diego",
		name: "Naval San Diego",
		lat: 32.68,
		lon: -117.13,
		type: "us-nato",
		description: "Pacific Fleet. Carrier homeport.",
	},
	{
		id: "nellis",
		name: "Nellis AFB",
		...
		lon: -115.03,
		type: "us-nato",
		description: "Air combat training. Red Flag exercises.",
	},
	{
		id: "langley",
		name: "Langley AFB",
		...
		lon: -76.36,
		type: "us-nato",
		description: "Air Combat Command HQ. F-22 wing.",
	},
	{
		id: "cheyenne",
		name: "Cheyenne Mtn",
		...
		lon: -104.85,
		type: "us-nato",
		description: "NORAD. Missile warning, space control.",
	},
	{
		id: "peterson",
		name: "Peterson SFB",
		...
		lon: -104.71,
		type: "us-nato",
		description: "US Space Command HQ. Space operations.",
	},
	{
		id: "kings_bay",
		name: "Kings Bay",
		...
		lon: -81.52,
		type: "us-nato",
		description: "Ohio-class submarine base. Atlantic deterrent.",
	},
	{
		id: "kitsap",
		name: "Naval Kitsap",
		...
		lon: -122.66,
		type: "us-nato",
		description: "Trident submarine base. Pacific deterrent.",
	},
	{
		id: "yokosuka",
		name: "Yokosuka",
		...
		lon: 139.67,
		type: "us-nato",
		description: "US 7th Fleet HQ. Carrier strike group homeport.",
	},
	{
		id: "rota",
		name: "Naval Rota",
		...
		lon: -6.35,
		type: "us-nato",
		description: "US/Spanish naval base. Aegis destroyers, Atlantic access.",
	},
	{
		id: "incirlik",
		name: "Incirlik AB",
		...
		lon: 35.43,
		type: "us-nato",
		description: "US/Turkish base. Nuclear weapons storage site.",
	},
	// Russian domestic bases (not overseas)
	{
		...
		lon: 20.51,
		type: "russia",
		description: "Russian exclave. Baltic Fleet, Iskander missiles.",
	},
	{
		id: "sevastopol",
		name: "Sevastopol",
		...
		lon: 33.5,
		type: "russia",
		description: "Black Sea Fleet HQ. Crimea (occupied).",
	},
	{
		id: "vladivostok",
		name: "Vladivostok",
		...
		lon: 131.9,
		type: "russia",
		description: "Pacific Fleet HQ. Nuclear submarines.",
	},
	{
		id: "murmansk",
		name: "Murmansk",
		...
		lon: 33.09,
		type: "russia",
		description: "Northern Fleet. Strategic nuclear submarines.",
	},
];
...
export const UNDERSEA_CABLES: UnderseaCable[] = [
	// === TRANS-ATLANTIC ===
	{
		...
		countriesServed: [
			{ country: "ES", capacityShare: 0.3, isRedundant: true },
	...
	},
	{
		...
		countriesServed: [
			{ country: "ES", capacityShare: 0.3, isRedundant: true },
			{ country: "GB", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "FR", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "BM", capacityShare: 0.3, isRedundant: true },
			{ country: "PT", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	// === TRANS-PACIFIC ===
	{
		...
		countriesServed: [
			{ country: "JP", capacityShare: 0.3, isRedundant: true },
			{ country: "TW", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "CL", capacityShare: 0.3, isRedundant: true },
			{ country: "PA", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "CN", capacityShare: 0.2, isRedundant: true },
			{ country: "JP", capacityShare: 0.2, isRedundant: true },
			{ country: "KR", capacityShare: 0.2, isRedundant: true },
			{ country: "TW", capacityShare: 0.2, isRedundant: true },
			{ country: "US", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "PH", capacityShare: 0.3, isRedundant: true },
			{ country: "TW", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	...
	},
	{
		...
		countriesServed: [
			{ country: "CA", capacityShare: 0.3, isRedundant: true },
			{ country: "JP", capacityShare: 0.3, isRedundant: true },
			{ country: "TW", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "GU", capacityShare: 0.2, isRedundant: true },
			{ country: "ID", capacityShare: 0.2, isRedundant: true },
			{ country: "PW", capacityShare: 0.2, isRedundant: true },
			{ country: "SG", capacityShare: 0.2, isRedundant: true },
			{ country: "US", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "AS", capacityShare: 0.2, isRedundant: true },
			{ country: "AU", capacityShare: 0.2, isRedundant: true },
			{ country: "NZ", capacityShare: 0.2, isRedundant: true },
			{ country: "TO", capacityShare: 0.2, isRedundant: true },
			{ country: "US", capacityShare: 0.2, isRedundant: true },
		],
	},
	...
	},
	{
		...
		owners: [
			...
			"SBIN (Société Béninoise des Infrastructures Numériques du Bénin)",
			"STP Cabo",
	...
	},
	{
		...
		countriesServed: [
			{ country: "CI", capacityShare: 0.2, isRedundant: true },
			{ country: "GH", capacityShare: 0.2, isRedundant: true },
			{ country: "NG", capacityShare: 0.2, isRedundant: true },
			{ country: "PT", capacityShare: 0.2, isRedundant: true },
			{ country: "SN", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
		id: "safe",
		...
		countriesServed: [
			{ country: "IN", capacityShare: 0.2, isRedundant: true },
			{ country: "MY", capacityShare: 0.2, isRedundant: true },
			{ country: "MU", capacityShare: 0.2, isRedundant: true },
			{ country: "RE", capacityShare: 0.2, isRedundant: true },
			{ country: "ZA", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
		id: "sat_3wasc",
		...
		owners: [
			...
			"Orange Cote d’Ivoire",
			"PCCW",
			"SBIN (La Société Béninoise d’Infrastructures Numériques)",
			"Singtel",
			"Sparkle",
			"Tata Communications",
			"Telecom Namibia",
	...
	},
	{
		...
		countriesServed: [
			{ country: "KE", capacityShare: 0.3, isRedundant: true },
			{ country: "AE", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "MG", capacityShare: 0.3, isRedundant: true },
			{ country: "MU", capacityShare: 0.3, isRedundant: true },
			{ country: "RE", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "BR", capacityShare: 0.3, isRedundant: true },
			{ country: "US", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "AO", capacityShare: 0.3, isRedundant: true },
			{ country: "BR", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "BR", capacityShare: 0.3, isRedundant: true },
			{ country: "CM", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		id: "arcos",
	...
	},
	{
		...
		countriesServed: [
			{ country: "BM", capacityShare: 0.2, isRedundant: true },
			{ country: "BR", capacityShare: 0.2, isRedundant: true },
			{ country: "CO", capacityShare: 0.2, isRedundant: true },
			{ country: "US", capacityShare: 0.2, isRedundant: true },
			{ country: "VE", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
		id: "malbec",
		...
		countriesServed: [
			{ country: "AR", capacityShare: 0.3, isRedundant: true },
			{ country: "BR", capacityShare: 0.3, isRedundant: true },
		],
	},
	...
	},
	{
		...
		countriesServed: [
			{ country: "AU", capacityShare: 0.3, isRedundant: true },
			{ country: "ID", capacityShare: 0.3, isRedundant: true },
	...
	},
	{
		...
		countriesServed: [
			{ country: "BN", capacityShare: 0.2, isRedundant: true },
			{ country: "CN", capacityShare: 0.2, isRedundant: true },
			{ country: "JP", capacityShare: 0.2, isRedundant: true },
			{ country: "PH", capacityShare: 0.2, isRedundant: true },
			{ country: "SG", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "AU", capacityShare: 0.3, isRedundant: true },
			{ country: "GU", capacityShare: 0.3, isRedundant: true },
			{ country: "JP", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "DJ", capacityShare: 0.2, isRedundant: true },
			{ country: "IN", capacityShare: 0.2, isRedundant: true },
			{ country: "JO", capacityShare: 0.2, isRedundant: true },
			{ country: "OM", capacityShare: 0.2, isRedundant: true },
			{ country: "SA", capacityShare: 0.2, isRedundant: true },
		],
	},
	...
	// === ARCTIC / EUROPE ===
	{
		...
		countriesServed: [
			{ country: "FO", capacityShare: 0.3, isRedundant: true },
			{ country: "IS", capacityShare: 0.3, isRedundant: true },
			{ country: "GB", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "FI", capacityShare: 0.3, isRedundant: true },
			{ country: "DE", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		id: "no_uk",
		...
		countriesServed: [
			{ country: "NO", capacityShare: 0.3, isRedundant: true },
			{ country: "GB", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
		...
		countriesServed: [
			{ country: "DK", capacityShare: 0.3, isRedundant: true },
			{ country: "GB", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "CA", capacityShare: 0.3, isRedundant: true },
			{ country: "GL", capacityShare: 0.3, isRedundant: true },
			{ country: "IS", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "DK", capacityShare: 0.3, isRedundant: true },
			{ country: "PL", capacityShare: 0.3, isRedundant: true },
			{ country: "SE", capacityShare: 0.3, isRedundant: true },
		],
	},
	...
	},
	{
		...
		countriesServed: [
			{ country: "BH", capacityShare: 0.2, isRedundant: true },
			{ country: "OM", capacityShare: 0.2, isRedundant: true },
			{ country: "QA", capacityShare: 0.2, isRedundant: true },
			{ country: "SA", capacityShare: 0.2, isRedundant: true },
			{ country: "AE", capacityShare: 0.2, isRedundant: true },
		],
	},
	{
	...
	},
	{
		...
		countriesServed: [
			{ country: "IR", capacityShare: 0.3, isRedundant: true },
			{ country: "OM", capacityShare: 0.3, isRedundant: true },
		],
	},
	{
...
export const ECONOMIC_CENTERS: EconomicCenter[] = [
	// Americas
	{
		...
		description: "New York Stock Exchange - World's largest stock exchange",
	},
	{
		id: "nasdaq",
		name: "NASDAQ",
		...
		country: "USA",
		marketHours: { open: "09:30", close: "16:00", timezone: "America/New_York" },
		description: "Tech-heavy exchange",
	},
	{
		id: "fed",
		...
		lon: -77.0459,
		country: "USA",
		description: "US Central Bank - Controls USD monetary policy",
	},
	{
		id: "cme",
		name: "CME Group",
		...
		lon: -87.6278,
		country: "USA",
		description: "Chicago Mercantile Exchange - Futures & derivatives",
	},
	{
		id: "tsx",
		name: "TSX",
	...
	},
	{
		...
		lon: -46.6333,
		country: "Brazil",
		description: "Brazilian Stock Exchange (B3/Bovespa)",
	},
	// Europe
	{
		id: "lse",
	...
	},
	{
		...
		lon: 8.6732,
		country: "Germany",
		description: "European Central Bank - Controls EUR",
	},
	{
		id: "euronext",
		name: "Euronext",
		...
		lon: 2.3364,
		country: "France",
		marketHours: { open: "09:00", close: "17:30", timezone: "Europe/Paris" },
		description: "Pan-European Exchange (Paris, Amsterdam, Brussels, Lisbon)",
	},
	{
		id: "dax",
		name: "Deutsche Börse",
		...
		description: "Frankfurt Stock Exchange - DAX",
	},
	{
		id: "six",
		name: "SIX Swiss",
	...
	// Asia-Pacific
	{
		...
		description: "Tokyo Stock Exchange - Nikkei",
	},
	{
		id: "boj",
		name: "Bank of Japan",
		...
		lon: 139.7579,
		country: "Japan",
		description: "Japan Central Bank - Controls JPY",
	},
	{
		id: "sse",
		name: "Shanghai SE",
		...
		lon: 121.4737,
		country: "China",
		marketHours: { open: "09:30", close: "15:00", timezone: "Asia/Shanghai" },
	...
	},
	{
		...
		lon: 114.0579,
		country: "China",
		description: "Shenzhen Stock Exchange - Tech focus",
	},
	{
		id: "pboc",
		name: "PBOC",
		...
		lon: 116.4074,
		country: "China",
		description: "People's Bank of China - Controls CNY",
	},
	{
		id: "hkex",
		name: "HKEX",
	...
	},
	{
		...
		lon: 126.978,
		country: "South Korea",
		marketHours: { open: "09:00", close: "15:30", timezone: "Asia/Seoul" },
		description: "Korea Exchange - KOSPI",
	},
	{
		id: "bse",
		name: "BSE",
		...
		description: "Bombay Stock Exchange - Sensex",
	},
	{
		id: "nse",
		name: "NSE India",
		...
		lon: 72.8621,
		country: "India",
		description: "National Stock Exchange - Nifty",
	},
	{
		id: "rbi",
		name: "RBI",
	...
	// Middle East & Africa
	{
		...
		marketHours: { open: "10:00", close: "15:00", timezone: "Asia/Riyadh" },
		description: "Saudi Stock Exchange - Largest in Arab world",
	},
	{
		id: "adx",
		name: "ADX",
		...
		lon: 54.3773,
		country: "UAE",
		marketHours: { open: "10:00", close: "14:00", timezone: "Asia/Dubai" },
	...
	},
	{
		...
		country: "UAE",
		marketHours: { open: "10:00", close: "14:00", timezone: "Asia/Dubai" },
		description: "Dubai Financial Market",
	},
	{
		id: "qse",
		name: "QSE",
		...
		lon: 51.531,
		country: "Qatar",
		marketHours: { open: "09:30", close: "13:15", timezone: "Asia/Qatar" },
	...
	},
	{
		...
		lon: 47.9774,
		country: "Kuwait",
		marketHours: { open: "09:00", close: "12:30", timezone: "Asia/Kuwait" },
		description: "Kuwait Stock Exchange",
	},
	{
		id: "bse_bahrain",
		name: "Bahrain Bourse",
		...
		lon: 50.586,
		country: "Bahrain",
		description: "Bahrain Stock Exchange",
	},
	{
		id: "egx",
		name: "EGX",
		...
		lon: 31.2357,
		country: "Egypt",
		marketHours: { open: "10:00", close: "14:30", timezone: "Africa/Cairo" },
		description: "Egyptian Exchange - Cairo",
	},
	{
		id: "tase",
		name: "TASE",
		...
		lon: 34.7818,
		country: "Israel",
		marketHours: { open: "09:59", close: "17:14", timezone: "Asia/Jerusalem" },
	...
	},
	{
		...
		marketHours: { open: "09:00", close: "17:00", timezone: "Africa/Johannesburg" },
	...
	},
	{
		...
		lon: 3.4218,
		country: "Nigeria",
		description: "Nigerian Exchange Group - Lagos",
	},
	{
		id: "casa",
		name: "Casablanca SE",
		...
		lon: -7.5898,
		country: "Morocco",
		description: "Casablanca Stock Exchange",
	},
	...
	},
	{
		...
		lon: 6.1319,
		country: "Luxembourg",
		description: "European investment fund center",
	},
];
...
export const CRITICAL_MINERALS: CriticalMineralProject[] = [
	// Lithium
	{
		...
		status: "producing",
		significance: "Largest hard-rock lithium mine",
	},
	{
		id: "atacama",
	...
	},
	{
		...
		status: "producing",
		significance: "Major hard-rock deposit",
	},
	{
		id: "silver_peak",
		name: "Silver Peak",
		...
		operator: "Albemarle",
		status: "producing",
		significance: "Only active US lithium mine",
	},
	// Cobalt
	{
		id: "mutanda",
		...
		operator: "Glencore",
		status: "producing",
		significance: "World largest cobalt mine",
	},
	{
		id: "tenke",
		...
		operator: "CMOC",
		status: "producing",
		significance: "Major Chinese-owned cobalt source",
	},
	// Rare Earths
	{
		id: "bayan_obo",
		...
		status: "producing",
		significance: "World largest REE mine (45% global production)",
	},
	{
		id: "mountain_pass",
		name: "Mountain Pass",
		...
		status: "producing",
		significance: "Only major US REE mine",
	},
	{
		id: "mount_weld",
		name: "Mount Weld",
		...
		operator: "Lynas",
		status: "producing",
		significance: "Major non-Chinese REE source",
	},
	// Nickel
	{
		id: "wedabay",
		...
		status: "producing",
		significance: "Massive nickel pig iron production",
	},
	{
		id: "norilsk",
		name: "Norilsk",
		...
		operator: "Nornickel",
		status: "producing",
		significance: "Major palladium/nickel source",
	},
];
