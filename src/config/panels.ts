...
const FULL_PANELS: Record<string, PanelConfig> = {
	...
	}, // trial: unlocked on web, locked on desktop
	cii: {
 ...
 */
export const VARIANT_PANEL_OVERRIDES: Partial<
	Record<string, Partial<Record<string, Partial<PanelConfig>>>>
> = {
	finance: {
