...
export const COMMODITY_MINERS: CommodityMiner[] = [
	...
	// ============================================================
	{
		...
		stockSymbol: "BHP",
		description:
			"World's largest mining company by market cap. Major iron ore, copper, and coal producer.",
		employees: 80000,
		marketCapUSD: 130,
	},
	{
	...
	},
	{
		...
		stockSymbol: "GLEN.L",
		description:
			"World's largest commodities trading and mining company. Dominant in cobalt and zinc.",
		employees: 135000,
		marketCapUSD: 60,
	},
	{
		...
		stockSymbol: "VALE",
		description:
			"World's largest iron ore and nickel producer. Critical supply chain for steel and batteries.",
		employees: 125000,
		marketCapUSD: 50,
	},
	{
		...
		stockSymbol: "AAL.L",
		description:
			"Global diversified miner. Largest PGM producer through Anglo American Platinum (Amplats).",
		employees: 90000,
		marketCapUSD: 30,
	},
	{
		...
		stockSymbol: "FCX",
		description:
			"World's largest publicly traded copper producer. Operates Grasberg (Indonesia) and Morenci (US).",
		employees: 25000,
		marketCapUSD: 55,
	},
	{
		...
		stockSymbol: "TECK",
		description:
			"Canada's largest diversified mining company. Major copper growth pipeline (QB2, Highland Valley).",
		employees: 10000,
		marketCapUSD: 18,
	},
	...
	},
	{
		...
		stockSymbol: "GOLD",
		description:
			"World's second-largest gold miner. Major Tier One assets in Nevada, Nevada, Mali, DRC.",
		employees: 36000,
		marketCapUSD: 30,
	},
	{
	...
	},
	{
		...
		stockSymbol: "KGC",
		description:
			"Senior gold producer with mines in USA, Brazil, Chile, West Africa, and Mauritania.",
		employees: 9000,
		marketCapUSD: 9,
	},
	{
	...
	// ============================================================
	{
		...
		stockSymbol: "ALB",
		description:
			"World's largest lithium producer. Operates Greenbushes (Australia) and Chilean brine assets.",
		employees: 6600,
		marketCapUSD: 8,
	},
	{
	...
	},
	{
		...
		stockSymbol: "MP",
		description:
			"Operator of Mountain Pass, the only US rare earth mining and processing facility.",
		employees: 550,
		marketCapUSD: 2,
	},
	{
		...
		stockSymbol: "LYC.AX",
		description:
			"Largest rare earth producer outside China. Operates Mt Weld mine and Kalgoorlie processing.",
		employees: 1400,
		marketCapUSD: 3,
	},
	{
		...
		description:
			"World's largest cobalt producer. Major DRC copper/cobalt operations (Tenke Fungurume).",
		employees: 25000,
		marketCapUSD: 20,
	},
	{
		...
		stockSymbol: "CCJ",
		description:
			"World's largest publicly traded uranium producer. Operates Cigar Lake and McArthur River.",
		employees: 3700,
		marketCapUSD: 18,
	},
	{
		...
		stockSymbol: "KAP",
		description:
			"World's largest uranium producer (~23% of global supply). State-owned Kazakh company.",
		employees: 22000,
		marketCapUSD: 8,
	},
	...
	// ============================================================
	{
		...
		stockSymbol: "GMKN.ME",
		description:
			"World's largest producer of palladium and high-grade nickel. Major platinum producer.",
		employees: 80000,
		marketCapUSD: 25,
	},
	{
	...
	},
	{
		...
		stockSymbol: "RGLD",
		description:
			"Precious metals royalty and streaming company. Portfolio of 190+ royalties globally.",
		employees: 30,
		marketCapUSD: 10,
	},
	{
	...
	},
	{
		...
		stockSymbol: "NCM.AX",
		description:
			"Australia's largest gold miner (acquired by Newmont 2023). Cadia, Lihir, Brucejack.",
		employees: 16000,
		marketCapUSD: 20,
	},
];
