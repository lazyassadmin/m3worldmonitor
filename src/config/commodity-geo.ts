...
export const MINING_SITES: MineSite[] = [
	...
	},
	{
		...
		status: "producing",
		significance:
			"High-grade West African gold mine. Historically one of Africa's largest producers.",
		openPitOrUnderground: "underground",
	},
	{
		id: "pueblo-viejo",
	...
	},
	{
		...
		status: "development",
		significance:
			"One of the world's largest undeveloped gold deposits. Est. ~2.3Moz/yr at full capacity.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Key Barrick operation in West Africa. ~700koz/yr. Subject to Malian mining code pressure.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"One of the world's largest gold mines by reserves. Deep underground operation (~3km).",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Largest gold mine in Central Asia. ~500koz/yr. Nationalized by Kyrgyzstan in 2022.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Largest gold mine in South America. ~400koz/yr. Transitioning to Yanacocha Sulfides project.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"High-grade Patagonian gold mine. ~300koz/yr. One of the highest-grade operations globally.",
		annualOutput: "300 Koz/yr",
		openPitOrUnderground: "underground",
	},
	{
	...
	},
	{
		...
		status: "producing",
		significance:
			"Mexico's largest open-pit mine. World's largest silver producer by output. Gold/zinc/lead by-products.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Europe's largest copper and silver producer. World's second-largest silver producer.",
		openPitOrUnderground: "underground",
	},
	...
	},
	{
		...
		status: "producing",
		significance:
			"World's second-largest copper mine. Also world's largest gold mine by contained gold.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Highest-grade major copper mine discovered in 30 years. Fastest-growing producer.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Major hard-rock lithium mine. World's largest spodumene project after Greenbushes.",
		openPitOrUnderground: "open-pit",
	},
	{
		id: "olaroz",
	...
	},
	{
		...
		status: "producing",
		significance:
			"One of Argentina's largest lithium brine projects. Recently commenced production.",
		openPitOrUnderground: "in-situ",
	},
	{
		id: "silver-peak",
	...
	// === RARE EARTHS ===
	{
		...
		status: "producing",
		significance:
			"World's largest rare earth mine. ~45% of global REE production from this single site.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Only significant rare earth mine and processor in the US. Strategic national asset.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Jiangxi/Guangdong ion-adsorption clay deposits. Key source of heavy rare earths (dysprosium, terbium) critical for EV motors.",
		openPitOrUnderground: "open-pit",
	},
	{
		id: "kvanefjeld",
		...
		status: "exploration",
		significance:
			"World-class REE + uranium deposit in Greenland. Subject to Greenland political debate.",
	},
	...
	// === NICKEL ===
	{
		...
		status: "producing",
		significance:
			"Largest nickel pig iron (NPI) production hub. Core of Indonesia's nickel dominance.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Largest integrated nickel production hub globally. Drives ~50% of world's battery-grade nickel.",
		openPitOrUnderground: "open-pit",
	},
	{
		id: "norilsk-mine",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Major Bushveld Complex platinum operations. Historically significant labor site.",
		openPitOrUnderground: "underground",
	},
	{
		id: "zimplats",
	...
	},
	{
		...
		status: "producing",
		significance:
			"World's largest iron ore mine by proven reserves. Highest grade iron ore (~67% Fe).",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Africa's largest iron ore mine. Major export source for European and Asian steel mills.",
		openPitOrUnderground: "open-pit",
	},
	{
		id: "kiruna",
		...
		status: "producing",
		significance:
			"Europe's largest iron ore mine. Undergoing city relocation due to mine expansion.",
		openPitOrUnderground: "underground",
	},
	...
	// === URANIUM ===
	{
		...
		status: "producing",
		significance:
			"World's highest-grade uranium mine. 25x average uranium ore grade. Saskatchewan, Canada.",
	...
	},
	{
		...
		status: "producing",
		significance:
			"Cluster of in-situ leaching uranium operations. Kazakhstan produces ~40% of world supply.",
...
export const PROCESSING_PLANTS: ProcessingPlant[] = [
	...
	// Lithium Processing
	{
		...
		status: "operating",
		significance:
			"China's major lithium chemical refining hub. Processes spodumene into battery-grade lithium.",
	...
	},
	{
		...
		status: "operating",
		significance:
			"First lithium hydroxide refinery in Australia. Processes Greenbushes concentrate.",
	...
	// Copper Smelters
	{
		...
		status: "operating",
		significance:
			"Major Chilean copper smelter. Part of integrated Andean copper production chain.",
	},
	{
		id: "nkana-smelter",
	...
	// Gold Refineries
	{
		...
		status: "operating",
		significance:
			"World's largest gold refinery by cumulative output. Processes most of SA gold production.",
	...
	},
	{
		...
		status: "operating",
		significance:
			"Switzerland's leading precious metals refinery. Produces LBMA-accredited gold bars.",
	},
	// Nickel Processing
	{
		id: "norilsk-smelter",
		...
		status: "operating",
		significance:
			"World's largest nickel and palladium smelter. Also major SO2 emitter (Arctic pollution concern).",
...
export const COMMODITY_PORTS: CommodityPort[] = [
	{
		...
		significance:
			"World's largest bulk export port. Handles ~18% of global seaborne iron ore trade.",
	},
	{
		id: "dampier-port",
	...
	},
	{
		...
		significance:
			"Chile's primary copper export port. Gateway for Escondida and northern Atacama mines.",
	},
	{
		id: "santos-brazil",
		name: "Port of Santos",
	...
	},
	{
		...
		significance:
			"Africa's largest dry bulk export terminal. Primary South African coal export point.",
	},
	{
		id: "mombasa-port",
	...
	},
	{
		...
		significance:
			"Peru's main port. Primary export point for Andean copper, zinc, and silver production.",
	},
	{
		id: "tianjin-port",
		...
		significance:
			"China's largest commodity import port. Primary iron ore, copper concentrate, and LME metals gateway.",
	},
	{
		...
		significance:
			"Major LME-licensed metals warehouse network in Europe. Zinc and copper storage hub.",
	},
];
