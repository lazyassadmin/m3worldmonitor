...
export function allButtons(): DlButton[] {
	...
	return [
		{
			cls: "mac",
			href: `${apiOrigin}/api/download?platform=macos-arm64`,
			label: `\uF8FF ${t("modals.downloadBanner.macSilicon")}`,
		},
		{
			cls: "mac",
			href: `${apiOrigin}/api/download?platform=macos-x64`,
			label: `\uF8FF ${t("modals.downloadBanner.macIntel")}`,
		},
		{
			cls: "win",
			href: `${apiOrigin}/api/download?platform=windows-msi`,
			label: `\u229E ${t("modals.downloadBanner.windows")}`,
		},
		{
			cls: "linux",
			href: `${apiOrigin}/api/download?platform=linux-appimage`,
			label: `\u{1F427} ${t("modals.downloadBanner.linux")} (x64)`,
		},
		{
			cls: "linux",
			href: `${apiOrigin}/api/download?platform=linux-appimage-arm64`,
