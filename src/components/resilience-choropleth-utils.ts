...
export type ResilienceChoroplethLevel =
	| "very_low"
	| "low"
	| "moderate"
	| "high"
...
export const RESILIENCE_CHOROPLETH_COLORS: Record<
	ResilienceChoroplethLevel,
...
export function normalizeExclusiveChoropleths(
	...
	const resilienceJustEnabled =
		layers.resilienceScore && !(previousLayers?.resilienceScore ?? false);
