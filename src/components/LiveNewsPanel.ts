...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
	...
	{ id: "bbc-news", name: "BBC News", handle: "@BBCNews", fallbackVideoId: "bjgQzJzCZKs" },
	{
		id: "gb-news",
		name: "GB News",
		hlsUrl: "https://live-gbnews.simplestreamcdn.com/live5/gbnews/bitrate1.isml/manifest.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "the-guardian",
	...
	{ id: "rtve", name: "RTVE 24H", handle: "@RTVENoticias", fallbackVideoId: "7_srED6k0bE" },
	{
		id: "phoenix",
		name: "Phoenix",
		hlsUrl: "https://zdf-hls-19.akamaized.net/hls/live/2016502/de/veryhigh/master.m3u8",
		useFallbackOnly: true,
		geoAvailability: ["DE", "AT", "CH"],
	},
	{
		id: "rtp3",
		name: "RTP3",
		hlsUrl: "https://streaming-live.rtp.pt/livetvhlsDVR/rtpnHDdvr.smil/playlist.m3u8?DVR=",
		useFallbackOnly: true,
		geoAvailability: ["PT", "BR"],
	},
	...
	{
		id: "telewizja-republika",
		name: "Telewizja Republika",
		handle: "@Telewizja_Republika",
		fallbackVideoId: "dzntyCTgJMQ",
	},
	...
	{ id: "jovem-pan", name: "Jovem Pan News", handle: "@jovempannews" },
	{
		...
		name: "Record News",
		handle: "@RecordNews",
		hlsUrl: "https://stream.ads.ottera.tv/playlist.m3u8?network_id=2116",
	},
	...
	},
	{
		id: "rt-espanol",
		name: "RT Español",
		hlsUrl: "https://rt-esp.rttv.com/dvr/rtesp/playlist.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "cgtn-espanol",
		name: "CGTN Español",
		hlsUrl: "https://news.cgtn.com/resource/live/espanol/cgtn-e.m3u8",
		useFallbackOnly: true,
	},
	// Asia
	...
	{ id: "india-today", name: "India Today", handle: "@indiatoday", fallbackVideoId: "sYZtOFzM78M" },
	{
		...
		name: "ABP News",
		handle: "@ABPNews",
		hlsUrl: "https://abplivetv.pc.cdn.bitgravity.com/httppush/abp_livetv/abp_abpnews/master.m3u8",
	},
	...
	},
	{
		...
		hlsUrl: "https://live-hls-web-ajm.getaj.net/AJM/index.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "alarabiya-business",
		name: "Al Arabiya Business",
		hlsUrl: "https://live.alarabiya.net/alarabiapublish/aswaaq.smil/playlist.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "al-qahera-news",
	...
	},
	{
		id: "press-tv",
		name: "Press TV",
		hlsUrl: "https://cdnlive.presstv.ir/cdnlive/smil:cdnlive.smil/playlist.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "dw-arabic",
		name: "DW Arabic",
		hlsUrl: "https://dwamdstream103.akamaized.net/hls/live/2015526/dwstream103/index.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "rt-arabic",
		name: "RT Arabic",
		hlsUrl: "https://rt-arb.rttv.com/dvr/rtarab/playlist.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "rudaw",
		name: "Rudaw",
		hlsUrl: "https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8",
		useFallbackOnly: true,
	},
	// Africa
	...
	{ id: "enca", name: "eNCA", handle: "@encanews" },
	{
		...
		hlsUrl: "https://sabconetanw.cdn.mangomolo.com/news/smil:news.stream.smil/playlist.m3u8",
	},
	{
		id: "arise-news",
		name: "Arise News",
	...
	{ id: "skai-tv", name: "SKAI TV", handle: "@skaitv" },
	{
		...
		name: "ERT News",
		handle: "@ertgr",
		hlsUrl: "https://ertflix.ascdn.broadpeak.io/ertlive/ertnews/default/index.m3u8",
		useFallbackOnly: true,
	},
	{
		id: "france24-fr",
	...
	{
		id: "aljazeera-balkans",
		name: "Al Jazeera Balkans",
		handle: "@AlJazeeraBalkans",
...
const DEFAULT_LIVE_CHANNELS =
	SITE_VARIANT === "tech" ? TECH_LIVE_CHANNELS : SITE_VARIANT === "happy" ? [] : FULL_LIVE_CHANNELS;
...
export function getFilteredChannelRegions(
	userCountry: string | null,
): typeof OPTIONAL_CHANNEL_REGIONS {
...
interface ProxiedHlsEntry {
	url: string;
	referer: string;
}
const PROXIED_HLS_MAP: Readonly<Record<string, ProxiedHlsEntry>> = {
	cnbc: {
		url: "https://cdn-ca2-na.lncnetworks.host/hls/cnbc_live/index.m3u8",
...
if (import.meta.env.DEV) {
	...
	for (const id of Object.keys(DIRECT_HLS_MAP)) {
		...
		if (!ch) console.error(`[LiveNews] DIRECT_HLS_MAP key '${id}' has no matching channel`);
			...
			console.error(
				`[LiveNews] Channel '${id}' in DIRECT_HLS_MAP lacks fallback (videoId/hlsUrl/handle)`,
			);
		}
	}
}
...
export function saveChannelsToStorage(channels: LiveChannel[]): void {
	...
	for (const c of [...FULL_LIVE_CHANNELS, ...TECH_LIVE_CHANNELS, ...OPTIONAL_LIVE_CHANNELS])
...
export class LiveNewsPanel extends Panel {
	...
	private renderPlaceholder(): void {
		...
		container.style.cssText =
			"display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:12px;cursor:pointer;";
	...
	private static resolveYouTubeOrigin(): string | null {
		const fallbackOrigin =
			SITE_VARIANT === "tech" ? "https://worldmonitor.app" : "https://worldmonitor.app";
	...
	private async resolveChannelVideo(channel: LiveChannel, forceFallback = false): Promise<void> {
		...
		const hlsCooldownActive =
			failedAt !== undefined && Date.now() - failedAt < this.HLS_COOLDOWN_MS;
