...
const prefSrc = readFileSync(resolve(__dirname, "../src/services/preferences-content.ts"), "utf-8");
const alertRulesSrc = readFileSync(resolve(__dirname, "../convex/alertRules.ts"), "utf-8");
...
describe("setQuietHours validates quietHoursTimezone (public mutation)", () => {
	...
	it("public mutation validates quietHoursTimezone via validateQuietHoursArgs or Intl.DateTimeFormat", () => {
		...
		assert.ok(hasValidator, "setQuietHours must validate quietHoursTimezone");
	});
