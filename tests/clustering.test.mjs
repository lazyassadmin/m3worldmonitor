...
describe("_clustering.mjs", () => {
	describe("clusterItems", () => {
		it("groups similar titles into one cluster", () => {
			const items = [
				{
					title: "Iran launches missile strikes on targets in Syria overnight",
					source: "Reuters",
					link: "http://a",
				},
				{
					title: "Iran launches missile strikes on targets in Syria overnight says officials",
					source: "AP",
					link: "http://b",
				},
			];
		...
		it("keeps different titles as separate clusters", () => {
			const items = [
				{
					title: "Iran launches missile strikes on targets in Syria",
					source: "Reuters",
					link: "http://a",
				},
		...
		it("preserves primaryTitle from highest-tier source", () => {
			const items = [
				...
				{
					title: "Iran strikes Syria overnight confirms officials",
					source: "Reuters",
					link: "http://a",
					tier: 1,
				},
	...
	describe("scoreImportance", () => {
		it("scores military/violence headlines higher than business", () => {
			const military = {
				primaryTitle: "Troops deployed after missile attack in Ukraine",
				sourceCount: 2,
			};
			const business = {
				primaryTitle: "Tech startup raises funding in quarterly earnings",
				sourceCount: 2,
			};
		...
		it("gives combo bonus for flashpoint + violence", () => {
			const flashpointViolence = {
				primaryTitle: "Iran crackdown killed dozens in Tehran protests",
				sourceCount: 1,
			};
		...
		it("demotes business context", () => {
			...
			const business = {
				primaryTitle: "Strike hits military targets says CEO in earnings call",
				sourceCount: 1,
			};
	...
	describe("selectTopStories", () => {
		...
		it("filters out low-scoring single-source non-alert stories", () => {
			const clusters = [
				{
					primaryTitle: "Nice weather today",
					primarySource: "Blog",
					primaryLink: "http://a",
					sourceCount: 1,
					isAlert: false,
		...
		it("includes high-scoring single-source stories", () => {
			const clusters = [
				{
					primaryTitle: "Iran missile attack kills dozens in massive airstrike",
