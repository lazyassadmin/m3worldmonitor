...
function normalizeOceanIceSeed(value: unknown): GetOceanIceDataResponse {
	...
	const arcticExtentMkm2 = asFiniteNumber(
		pickKey(seeded, "arctic_extent_mkm2", "arcticExtentMkm2"),
	);
	if (arcticExtentMkm2 != null) normalized.arcticExtentMkm2 = arcticExtentMkm2;

	const arcticExtentAnomalyMkm2 = asFiniteNumber(
		pickKey(seeded, "arctic_extent_anomaly_mkm2", "arcticExtentAnomalyMkm2"),
	);
	...
	const seaLevelMmAbove1993 = asFiniteNumber(
		pickKey(seeded, "sea_level_mm_above_1993", "seaLevelMmAbove1993"),
	);
	if (seaLevelMmAbove1993 != null) normalized.seaLevelMmAbove1993 = seaLevelMmAbove1993;

	const seaLevelAnnualRiseMm = asFiniteNumber(
		pickKey(seeded, "sea_level_annual_rise_mm", "seaLevelAnnualRiseMm"),
	);
