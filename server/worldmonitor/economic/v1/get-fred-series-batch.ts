...
const ALLOWED_SERIES = new Set<string>([
	...
	"T10Y3M",
	"STLFSI4", // Economic Stress Index components (seeded by seed-economy.mjs)
	"DGS1MO",
	"DGS3MO",
	"DGS6MO",
	"DGS1",
	"DGS2",
	"DGS5",
	"DGS30", // yield curve tenors
	"BAMLC0A0CM",
	"SOFR", // IG OAS spread + Secured Overnight Financing Rate (seeded by seed-economy.mjs)
	"ESTR",
	"EURIBOR3M",
	"EURIBOR6M",
	"EURIBOR1Y", // ECB short rates (seeded by seed-ecb-short-rates.mjs)
]);
